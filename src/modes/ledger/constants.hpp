...
namespace LedgerConst {
    namespace Property {
        inline constexpr std::string_view MODE_NAME = "ledger";
    }
    ...
    namespace Entry {
        ...
        inline constexpr std::string_view ROTATE_KEY = "ROTATE_KEY";
        ...
        inline constexpr std::string_view TAIL = "TAIL";
